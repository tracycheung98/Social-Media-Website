...
export default function Upload() {
    ...
    const handlePhotoChange = async (e) => {
        ...
        // Resize the photo before setting it in the state
        const resizedPhoto = await resizePhoto(selectedPhoto, 300); // Adjust the desired width
    ...
    const handlePublicSubmit = async () => {
        ...
        try {
            // Generate a unique ID for each photo entry
